            ...
            <div className="lg:col-span-2">
              <div className="border-b border-gray-300 pb-6 mb-6">
                ...
                <div className="text-sm leading-relaxed text-gray-800 space-y-3">
                  ...
                  <p>
                    The blaze, which started at approximately 11:30pm according to Fire Chief Harold Baxon Lodge in 1956" and Troy Deere, President of the Twin Hills Coffee Corporation, resulted in damage estimated during this disaster.
                  </p>
                  <p>
                  ...
                  <p>
                    "It's truly one of the worst fires we've had in the Twin Hills Fire Department say about is suspected. It was evident that the fire spread from to the room..." continued reading about how yesterday morning firefighters were battling the flames.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    The scene of the fire remains under investigation, though Deputy Fire Chief Marshall of the Twin Hills Fire Department say work is expected to continue, but the investigation continues.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-serif font-bold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    Employees of the Twin Hills roaster were safely evacuated according to the latest reports about their yesterday safety protocols.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="border-2 border-gray-400 p-4 bg-gray-50">
                <h3 className="text-xl font-serif font-bold text-gray-900 mb-3">
                  Workers Being Moved to Other Plants to Meet Current Orders
                </h3>
                <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  <strong>Twin Hills, Wa.</strong> — Due to the impact to shift current orders, the Twin Hills Coffee Corporation is temporarily relocating employees from the Twin Hills warehouse to other facilities to maintain operations.
                </p>
                <p className="text-sm text-gray-700 leading-relaxed">
              ...
              <div className="border border-gray-300 p-4">
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  Company officials said production capacity will be reduced by approximately 55% of its production until the Main Street facilities are restored.
                </p>
              </div>
              ...
              <div className="border border-gray-300 p-4">
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  Much of the market coffee was sold to overseas markets, according to the company. The Twin Hills Vice President of Sales reported continued demand.
                </p>
              </div>
            </div>
          </div>
